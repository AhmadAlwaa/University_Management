...
public class deleteSubject {
    ...
    public static void deletingSubject(String subjectToDelete) throws IOException {
        ...
        for (int i = 1; i <= rowCount; i++) {
            ...
            if (idCell != null && idCell.getCellType() == CellType.STRING && idCell.getStringCellValue().equals(subjectToDelete)) {
